...
EasyTransition.propTypes = {
    ...
    initialStyle: _react2['default'].PropTypes.object.isRequired,
    transition: _react2['default'].PropTypes.string.isRequired,
    finalStyle: _react2['default'].PropTypes.object.isRequired,
    leaveStyle: _react2['default'].PropTypes.object
};
